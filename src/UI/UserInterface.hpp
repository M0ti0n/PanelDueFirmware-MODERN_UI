...
namespace UI
{
	...
	extern void EnableControlMacroNavButtons(bool scrollEarlier, bool scrollLater, bool parentDir);
	extern void UpdateControlMacroFileButton(unsigned int buttonIndex, const char * _ecv_array null text, const char * _ecv_array null param);
